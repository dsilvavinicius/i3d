#!/bin/bash
python experiment_scripts/train_sdf_preproc.py --model_type=sine --point_cloud_path=data/double_torus.xyz --batch_size=512 --experiment_name=double_torus --num_epochs=100
