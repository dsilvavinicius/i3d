...
python experiment_scripts/train_curv_fracs.py --mesh_path=data/armadillo.ply --batch_size=10000 --experiment_name=armadillo_biased_b10000_w0-30_05-04-01_p70-p90 --num_epochs=1000 --w0=30
